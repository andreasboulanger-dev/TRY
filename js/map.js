...
// deal details", "View prices", "View details"…) — used by the
// click-anywhere handler (deals.js: dealPopupCardClick). When a card has
// more than one action button (e.g. a combined deal+price popup), the
// last one wins — it's whichever was appended last, which is the primary
// content for that card.
...
// its own click normally.
(function() {
  let startY = 0, currentY = 0, dragging = false, dragMode = null; // dragMode: 'sheet' | 'dismiss'
  let startHeight = 0;
